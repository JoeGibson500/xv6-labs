...
//the fmtname function extracts the name of a file or directory from a given path
//it char*locates the last slash in the path, which seperates the name from the rest of the path
...
00000000000000b4 <ls>:
2. for directories 
 - it reads the contents of the directory and prints information about the files and subdirectories it contains  
*/
void
ls(char *path)
{
