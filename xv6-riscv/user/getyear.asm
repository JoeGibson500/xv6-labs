...
user/_getyear:     file format elf64-littleriscv
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3a4:	4c850513          	addi	a0,a0,1224 # 868 <digits>
 3a8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 464:	3b0c8c93          	addi	s9,s9,944 # 810 <malloc+0x122>
 ...
 472:	3fab8b93          	addi	s7,s7,1018 # 868 <digits>
 ...
 598:	27498993          	addi	s3,s3,628 # 808 <malloc+0x11a>
        while(*s != 0){
 59c:	85ee                	mv	a1,s11
